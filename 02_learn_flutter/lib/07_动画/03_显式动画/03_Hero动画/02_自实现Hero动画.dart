...
import './03_AfterLayout.dart';

class MJCustomHeroAnimation extends StatefulWidget {
  const MJCustomHeroAnimation({super.key});
  @override
  State<MJCustomHeroAnimation> createState() => _MJCustomHeroAnimationState();
}

class _MJCustomHeroAnimationState extends State<MJCustomHeroAnimation> with SingleTickerProviderStateMixin {
  ...
  Widget wChild2() {
    ...
    return GestureDetector(
      ...
      child: Image.asset("images/avatar.png", width: 400),
    );
  }
