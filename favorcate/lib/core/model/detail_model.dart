...
//
//     final ZMJDetailModel = ZMJDetailModelFromJson(jsonString);

import 'dart:convert';

ZMJDetailModel ZMJDetailModelFromJson(String str) => ZMJDetailModel.fromJson(json.decode(str));

String ZMJDetailModelToJson(ZMJDetailModel data) => json.encode(data.toJson());

class ZMJDetailModel {
  String iid;
  Result result;
  Status status;
  ...
  factory ZMJDetailModel.fromJson(Map<String, dynamic> json) => ZMJDetailModel(
    iid: json["iid"],
